...
def positive_assert(first_name):
    user_body = get_user_body(first_name) # на самом деле здесь все тело а не только "аа" вернется из-за copy в функции выше
    user_response = sender_stand_request.post_new_user(user_body) # здесь вызывается создание пользователя с телом, где first_name "аа"
